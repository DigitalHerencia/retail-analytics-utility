    ...
    <Card className="card-sharp border-white">
      <CardContent className="p-6">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-bold gangster-font text-white">{customer.name}</h2>
          ...
          <div>
            {customer.status === "paid" ? (
              <Badge className="bg-money/20 text-white hover:bg-white/20 border-white/20 rounded-none">PAID</Badge>
            ) : customer.status === "partial" ? (
              <Badge className="bg-white/20 text-white hover:bg-white/20 border-white/20 rounded-none">PARTIAL</Badge>
            ) : daysOverdue() > 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-smoke p-4">
            ...
            <div className="text-xl font-bold mt-1 text-white gangster-font">{formatCurrency(customer.amountOwed)}</div>
          </div>
          <div className="bg-smoke p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-3">
            <h3 className="text-lg font-semibold gangster-font text-white">CONTACT INFO</h3>
            ...
            {customer.notes && (
              <div className="flex items-start mt-4">
                <FileText className="h-4 w-4 mr-2 text-white mt-1" />
                <div>
          ...
          <div>
            <h3 className="text-lg font-semibold gangster-font text-white mb-3">PAYMENT PROGRESS</h3>
            <div className="w-full bg-secondary h-4">
              <div className="bg-white h-4" style={{ width: `${paymentPercentage}%` }}></div>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-semibold gangster-font text-white">PAYMENT HISTORY</h3>
            <Button
        ...
        <div className="flex justify-end space-x-4 mt-6">
          <Button variant="outline" onClick={onEdit} className="border-white/20 text-white hover:bg-white/10 button-sharp">
