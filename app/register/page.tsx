...
export default function RegisterPage() {
  ...
  useEffect(() => {
    const demoData = generateDemoData() // Call without arguments
    setTransactions(demoData.transactions)
    setCustomers(demoData.customers) // Use demoData.customers
    setInventory(demoData.inventory) // Use demoData.inventory
  }, [])
