...
export default function ForecastPage() {
  ...
  useEffect(() => {
    try {
      ...
      const safeCustomers = (demoData.customers || sampleCustomers).map((customer: Customer) => ({
        ...customer,
      ...
      const safeInventory = (demoData.inventory || sampleInventory).map((item: InventoryItem) => ({
        ...item,
